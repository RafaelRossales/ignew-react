...
//Quando é feito uma autenticação dentro do next
// os dados do usuário sao salvos em cookies na maquina do mesmo
export default async(req:NextApiRequest, res:NextApiResponse) =>{
    ...
    if(req.method ===   'POST')
    {
        ...
        const stripeCheckoutSection = await stripe.checkout.sessions.create({
            ...
            billing_address_collection:'required', // obriga o usuario a preencher o endereço
            line_items:[
                {price:'price_1If8QRImqRtF91oF8pgybjNw',quantity:1}
            ],
            mode:'subscription',
